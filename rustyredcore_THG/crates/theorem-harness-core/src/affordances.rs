...
const STATIC_AFFORDANCES: &[StaticAffordanceContract] = &[
    ...
    StaticAffordanceContract {
        affordance_id: "design.extract.static_facts",
        engine_id: "design-check",
        family: "design",
        label: "Design static fact extraction",
        input_shape: "dembrandt_extraction_or_design_fact_json",
        output_shape: "design_fact_set",
        writeback_policy: "read-only",
        execution_surface: "design-check",
        parity_status: "browserless-parity-cut",
        source_module: "design_check::design_fact_set_from_json",
        permissions: &["local_read"],
        tags: &["design", "facts", "dembrandt", "browserless"],
    },
    StaticAffordanceContract {
        affordance_id: "design.audit",
        engine_id: "design-check",
        family: "design",
        label: "Design audit",
        input_shape: "design_fact_set",
        output_shape: "design_audit_report",
        writeback_policy: "read-only",
        execution_surface: "design-check",
        parity_status: "browserless-parity-cut",
        source_module: "design_check::design_audit",
        permissions: &["local_read"],
        tags: &["design", "validator", "wcag", "apca", "gate"],
    },
    StaticAffordanceContract {
        affordance_id: "design.drift",
        engine_id: "design-check",
        family: "design",
        label: "Design drift",
        input_shape: "baseline_and_candidate_design_fact_sets",
        output_shape: "design_drift_report",
        writeback_policy: "read-only",
        execution_surface: "design-check",
        parity_status: "browserless-parity-cut",
        source_module: "design_check::design_drift",
        permissions: &["local_read"],
        tags: &["design", "drift", "baseline", "gate"],
    },
    StaticAffordanceContract {
        affordance_id: "design.tokens",
        engine_id: "design-check",
        family: "design",
        label: "Design token output",
        input_shape: "design_fact_set",
        output_shape: "dtcg_or_tailwind_tokens",
        writeback_policy: "read-only",
        execution_surface: "design-check",
        parity_status: "browserless-parity-cut",
        source_module: "design_check::{design_tokens_dtcg,design_tokens_tailwind}",
        permissions: &["local_read"],
        tags: &["design", "tokens", "dtcg", "tailwind"],
    },
    StaticAffordanceContract {
        affordance_id: "design.report",
        engine_id: "design-check",
        family: "design",
        label: "Design HTML report",
        input_shape: "design_fact_set_and_optional_drift_report",
        output_shape: "self_contained_html_report",
        writeback_policy: "read-only",
        execution_surface: "design-check",
        parity_status: "browserless-parity-cut",
        source_module: "design_check::design_html_report",
        permissions: &["local_read"],
        tags: &["design", "report", "html"],
    },
    StaticAffordanceContract {
