...
// ===========================================================================
//
// Moved to `pilot_core::masking` (the Servo-free automation core, migrated in
// place toward an open-source "WebDriver BiDi for Servo"). Re-exported so the
// consumers and the masking tests below are unchanged.
pub use pilot_core::{MaskedText, SensitiveData};
