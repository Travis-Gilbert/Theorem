...
use crate::text_region::{doc_tree_path, load_doc_tree, open_object_store, TextRegionHandle};
...
impl SubstratePeer {
        ...
        E: ThgExecutor + 'static,
    {
        ...
        let doc_tree_path = doc_tree_path(&data_dir);
        let doc_tree = load_doc_tree(&data_dir)?;
        ...
        Ok(Self {
            ...
            text_client_id,
            doc_tree: Arc::new(Mutex::new(doc_tree)),
            doc_tree_path,
            object_store,
