...
pub use types::{
    ...
    AFFORDANCE_LABEL, CONNECTOR_FAMILY, CONNECTOR_LABEL, DEFAULT_BASE_FITNESS,
    DEFAULT_COLD_START_SCORE, DEFAULT_MIN_FITNESS, INVOCATION_RECEIPT_LABEL, OFFERS,
    PRODUCED_OUTCOME, SEQUENCED_WITH, SERVED_TASK, TASK_TYPE_LABEL, THG_AFFORDANCE_SOURCE,
};
