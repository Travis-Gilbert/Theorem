...
| `code_search` | Theseus `/code/symbols/` | theseus-engine | explicit Theseus/code engine fallback | Keep explicit until native code-symbol ingestion/search is present. |
