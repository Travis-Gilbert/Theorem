...
const TITLES = [
  ...
  "Oxblood accent #A8301E holds 6.6:1 on white",
...
export const ROOMS: Room[] = [
  {
    ...
    events: [
      ...
      { id: "rev4", kind: "message", actor: "claude-ai", text: "Palette locked: oxblood #A8301E, status green #5f7d4f.", at: isoAgo(120), mentions: ["claude-code"] },
    ],
  },
  {
    id: "room_embedded",
...
export const INBOX: InboxItem[] = [
  ...
  },
  {
    ...
    from: "claude-ai",
    preview: "Palette locked: oxblood #A8301E, status green #5f7d4f.",
    body: "Reflection for the next head: palette is locked (oxblood #A8301E, status green #5f7d4f). The Dynamic Island carries the reuno-ui ai-input treatment. Don't reintroduce a second accent.",
    at: isoAgo(300),
    read: true,
    room: "harness-console",
    href: "/rooms",
