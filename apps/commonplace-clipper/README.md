...
This app is the CommonPlace fork of Obsidian Web Clipper. It preserves the upstream highlighter, reader, extraction, template, interpreter, and browser-extension surfaces while adding the CommonPlace capture destination documented in [docs/commonplace-capture-contract.md](docs/commonplace-capture-contract.md).
