...
| `apps/copresence-editor/` | `copresence-editor`: standalone Vite + React + TypeScript browser adapter for `theorem-copresence`. Velt/Yjs + Tiptap provide human co-editing, with an OpenAI-compatible Gemma co-writer seam. Plan: `docs/plans/copresence-velt-gemma/PLAN.md`. |
