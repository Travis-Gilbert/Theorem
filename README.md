...
- Last sync recorded in `README.md` (2026-06-17; added `apps/theorem-gateway`, the browser-facing GraphQL gateway over theorem-grpc + GL-Fusion). Bump it when you re-sync.
